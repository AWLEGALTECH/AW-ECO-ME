-- Título de "cliente assinou o contrato" com emoji 🎉.
-- Força o título direto no fn_criar_notificacao (assim independe do que a edge
-- function zapsign-webhook passa — o emoji fica controlado no banco).
